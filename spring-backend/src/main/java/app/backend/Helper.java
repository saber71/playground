...
public class Helper {
  ...
  private final Map<Class<?>, List<Field>> classMapFields = new HashMap<>();

  @Contract("_, _ -> param1")
  public <T> T assign(@NotNull T dst, Object @NonNull ... src) {
    for (Object item : src) {
  ...
  public @NotNull List<Field> getAllFields(Class<?> clazz) {
  ...
  public @Nullable Field getField(Class<?> clazz, String name) {
