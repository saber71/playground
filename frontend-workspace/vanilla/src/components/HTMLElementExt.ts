...
export interface Ext {
   ...
   */
  getParent<E extends HTMLElement>(): (E & Ext) | null
   ...
   */
  addChildren(...children: HTMLElement[]): this
   ...
   */
  getChild<E extends HTMLElement>(index: number): E & Ext
   ...
   */
  queryByClassName<El extends HTMLElement>(className: string): Array<Ext & El>
   ...
   */
  queryBySelector<El extends HTMLElement>(selector: string): (El & Ext) | null
   ...
   */
  queryAllBySelector<El extends HTMLElement>(selector: string): Array<El & Ext>
   ...
   * @returns 返回当前实例以支持链式调用
   */
  attr<El extends HTMLElement, Key extends PropertyKeys<El>>(name: Key, value: El[Key]): this
 ...
 */
export function isHTMLElementExt(obj: any): obj is HTMLElement & Ext {
 ...
 */
export function HTMLElementExt<El extends HTMLElement>(element: El): El & Ext {
